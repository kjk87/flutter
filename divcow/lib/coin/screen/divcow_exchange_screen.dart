...
import 'package:divcow/coin/components/divcow_exchange_box.dart';
...
class DivCowExchangeScreen extends StatefulWidget {
  const DivCowExchangeScreen({super.key});

  @override
  State<DivCowExchangeScreen> createState() => _DivCowExchangeScreenState();
}

class _DivCowExchangeScreenState extends State<DivCowExchangeScreen> {
  String? address;
  int exchangeDivCow = 0;
  ...
  Widget build(BuildContext context) {
    ...
    if (WalletUtil.instance.appKitModal.isConnected) {
      address = WalletUtil.instance.appKitModal.session!
          .getAddress(NetworkUtils.solana);
      WalletUtil.instance.getUSDTBalance(address!);
    }
              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: WalletUtil.instance.walletInit &&
                          !WalletUtil.instance.appKitModal.isConnected,
                      child: Container(
                        margin: const EdgeInsets.only(
                          ...
                          children: [
                            Row(
                              children: [
                                InkWell(
                                  onTap: () async {
                                    await WalletUtil.instance.appKitModal
                                        .disconnect();
                                    setState(() {});
                                  },
                                  child: Container(
                            ...
                            InkWell(
                              onTap: () {
                                if (textController.text.isNotEmpty) {
                                  exchangeDivCow = textController.text.toInt()!;
                                } else {
                                  exchangeDivCow = 0;
                                }
                                if (!showProgress && exchangeDivCow >= 10) {
                                  setState(() {
                                    popupVisible = true;
                    ...
                    Visibility(
                      ...
                      child: divcowExchangeBox(exchangeDivCow, (isExchange) async {
                        setState(() {
                          popupVisible = false;
                          if (isExchange) {
                            showProgress = true;
